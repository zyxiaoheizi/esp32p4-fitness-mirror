...
typedef struct {
    ...
    uint32_t    frame_delay_ms; /* Delay between MJPEG frames. 0 means decode as fast as possible */
    struct {
...
/**
 * @brief Resize the LVGL player container and rescale the current frame.
 */
